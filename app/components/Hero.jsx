  ...
  return (
    <section className="hero">
      <div className="row m-0 h-100 position-relative">
        ...
        {/* hero info */}
        <div className="col-md-7 ps-md-0 p-md-2 p-0 d-flex flex-column justify-content-center order-last order-md-first">
          ...
          <div className="buttons">
            <Stack direction="row" spacing={2}>
              ...
              <Button className="d-md-inline-block d-none" onClick={() => setIsResumeModal(true)} sx={theme == "light" ? {borderColor: "#7C3AED", color: "#000"} : {borderColor: "#737373", color: "#fff"}} variant="outlined" color="secondary">RESOME</Button>
            </Stack>
          </div>
        </div>
